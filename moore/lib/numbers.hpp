...
// SI dividers
rai::uint128_t const Gmol_ratio = rai::uint128_t ("1000000000000000000000000000000"); // 10^30
rai::uint128_t const Mmol_ratio = rai::uint128_t ("1000000000000000000000000000"); // 10^27
rai::uint128_t const kmol_ratio = rai::uint128_t ("1000000000000000000000000"); // 10^24
rai::uint128_t const mol_ratio = rai::uint128_t ("1000000000000000000000"); // 10^21
rai::uint128_t const mmol_ratio = rai::uint128_t ("1000000000000000000"); // 10^18
rai::uint128_t const umol_ratio = rai::uint128_t ("1000000000000000"); // 10^15
