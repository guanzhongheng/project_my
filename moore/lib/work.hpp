...
public:
	...
	static uint64_t const publish_threshold = rai::moore_network == rai::moore_networks::moore_test_network ? publish_test_threshold : publish_full_threshold;
};
}
