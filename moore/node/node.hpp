...
#include <moore/ledger.hpp>
#include <moore/lib/work.hpp>
#include <moore/node/bootstrap.hpp>
#include <moore/node/wallet.hpp>
...
public:
	...
	static unsigned constexpr announce_interval_ms = (rai::moore_network == rai::moore_networks::moore_test_network) ? 10 : 16000;
...
public:
	...
	static int constexpr mapping_timeout = rai::moore_network == rai::moore_networks::moore_test_network ? 53 : 3593;
	static int constexpr check_timeout = rai::moore_network == rai::moore_networks::moore_test_network ? 17 : 53;
...
public:
	...
	static uint16_t const node_port = rai::moore_network == rai::moore_networks::moore_live_network ? 17075 : 54000;
};
class logging
{
public:
