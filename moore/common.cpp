...
#include <moore/blockstore.hpp>
#include <moore/lib/interface.h>
#include <moore/node/common.hpp>
#include <moore/versioning.hpp>
...
char const * test_public_key_data = "B0311EA55708D6A53C75CDBF88300259C6D018522FE3D4D0A242E431F9E8B6D0"; // mol_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo
char const * beta_public_key_data = "259A4336B1913D6E44645545694EB665E0587994BE5F95D2D259D86B376E1711"; // mol_1betaeud56bxfs48aoc7f79desh1d3wsbhkzkqbf6pgrfeupw7rjuh3aqqhk
char const * live_public_key_data = "FB4CA6A201DC427B04A294C10170621B8BD6B9B6D8E46E54A8EFA2D6EEA19EB1"; // mol_1bananobh5rat99qfgt1ptpieie5swmoth87thi74qgbfrij7dcgjiij94xr
char const * test_genesis_data = R"%%%({
	"type": "open",
	"source": "B0311EA55708D6A53C75CDBF88300259C6D018522FE3D4D0A242E431F9E8B6D0",
	"representative": "mol_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo",
	"account": "mol_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo",
...
char const * beta_genesis_data = R"%%%({
	...
	"representative": "mol_1betaeud56bxfs48aoc7f79desh1d3wsbhkzkqbf6pgrfeupw7rjuh3aqqhk",
	"account": "mol_1betaeud56bxfs48aoc7f79desh1d3wsbhkzkqbf6pgrfeupw7rjuh3aqqhk",
...
char const * live_genesis_data = R"%%%({
	"type": "open",
	"source": "FB4CA6A201DC427B04A294C10170621B8BD6B9B6D8E46E54A8EFA2D6EEA19EB1",
	"representative": "mol_3ytentj15q44he4c778317r868wdttwufp96fsccjux4tuqc59ojgrwn6d4w",
	"account": "mol_3ytentj15q44he4c778317r868wdttwufp96fsccjux4tuqc59ojgrwn6d4w",
	"work": "dd0f6eae55a0ec80",
	"signature": "0595DD6EECFFC09A0E71D265A1B3062FBDF535CCA7A42E53E93CDDCC165AF5921F4F730352E2205E862034180A09F90A8116A8BE9A2928FF39C6D2D5393EA904"
})%%%";
...
public:
	...
	moore_test_account (test_public_key_data),
	moore_beta_account (beta_public_key_data),
	moore_live_account (live_public_key_data),
	moore_test_genesis (test_genesis_data),
	moore_beta_genesis (beta_genesis_data),
	moore_live_genesis (live_genesis_data),
	genesis_account (rai::moore_network == rai::moore_networks::moore_test_network ? moore_test_account : rai::moore_network == rai::moore_networks::moore_beta_network ? moore_beta_account : moore_live_account),
	genesis_block (rai::moore_network == rai::moore_networks::moore_test_network ? moore_test_genesis : rai::moore_network == rai::moore_networks::moore_beta_network ? moore_beta_genesis : moore_live_genesis),
	...
	rai::account moore_test_account;
	rai::account moore_beta_account;
	rai::account moore_live_account;
	std::string moore_test_genesis;
	std::string moore_beta_genesis;
	std::string moore_live_genesis;
...
rai::account const & rai::moore_test_account (globals.moore_test_account);
rai::account const & rai::moore_beta_account (globals.moore_beta_account);
rai::account const & rai::moore_live_account (globals.moore_live_account);
std::string const & rai::moore_test_genesis (globals.moore_test_genesis);
std::string const & rai::moore_beta_genesis (globals.moore_beta_genesis);
std::string const & rai::moore_live_genesis (globals.moore_live_genesis);
