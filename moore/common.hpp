...
#include <moore/node/utility.hpp>
...
extern rai::account const & moore_test_account;
extern rai::account const & moore_beta_account;
extern rai::account const & moore_live_account;
extern std::string const & moore_test_genesis;
extern std::string const & moore_beta_genesis;
extern std::string const & moore_live_genesis;
